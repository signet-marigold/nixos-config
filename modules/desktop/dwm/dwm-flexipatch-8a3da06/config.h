...
static char normbordercolor[]            = "#db8fd9";
...
static char urgbordercolor[]             = "#ffc146";
...
// Init commands
// nixos IBUS starts using a .desktop file, which dwm doesn't run. have to start manually
	"ibus-daemon", "--daemonize", "--xim", NULL,
// DBUS is also not starting for some reason, oh well
	"dbus-update-activation-environment", "--all", NULL,
// enable virbr0 virtual network bridge
	"virsh", "net-start", "default", NULL,
// Other startup apps
	"st", NULL,
	NULL /* terminate */
};
...
/* volume */
static const char *volumecmd[3][3] = {
	{ "hhst-volume", "-i", NULL },
	{ "hhst-volume", "-d", NULL },
	{ "hhst-volume", "-m", NULL }
};
/* playerctl */
static const char *playcontrolcmd[3][3] = {
	{ "playerctl", "next",       NULL },
...
static const Key keys[] = {
	...
	TAGKEYS(                        XK_9,                                  8)
	// CUSTOM KEYBINDS
	// dead with no patch { MODKEY|ShiftMask,             XK_BackSpace, quitprompt,     {0} },
	...
	{ 0,                XF86XK_AudioNext,         spawn,          {.v = playcontrolcmd[0]} },
	{ 0,                XF86XK_AudioPrev,         spawn,          {.v = playcontrolcmd[1]} },
	{ 0,                XF86XK_AudioPlay,         spawn,          {.v = playcontrolcmd[2]} },
};
